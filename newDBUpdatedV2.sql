...
CREATE TABLE [dbo].[QUERIES](
	...
	[userEmail] [nvarchar] (20) NOT NULL,
	[queryDesc] [nvarchar] (200),
	[instructorId] [int] NULL,
	[instructorReply] [nvarchar] (200),
PRIMARY KEY CLUSTERED 
(
	[queryId] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
...
FOREIGN KEY (userEmail) REFERENCES AppUser(Email)
GO
...
GO
INSERT [dbo].[AppUser] ([UserId], [FirstName], [LastName], [DateOfBirth],[PhoneNumber],[Email], [Password], [Role]) VALUES (3, N'Admin', N'One','1989-02-02', 22334566, N'admin@bounceanddance.com', N'Administrator1!', N'admin')
GO
