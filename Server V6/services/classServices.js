...
let getPendingClassByInstructorId = async(instructorId) => {
    let classes;

    // get class
    classes = await classRepository.getPendingClassesByInstructorId(instructorId);

    return classes;
};
let getApprovedClassByInstructorId = async(instructorId) => {
    let classes;

    // get class
    classes = await classRepository.getApprovedClassesByInstructorId(instructorId);
...
let deleteClass = async(classId) => {
    ...
    deleteResult = await classRepository.deleteClassById(classId);
...
let approveClass = async(classId) => {
    ...
    updateClass = await classRepository.approveClass(classId);
    return updateClass;
};
...
module.exports = {
    ...
    getClassByUserEmail,
    deleteClass,
    getPendingClassByInstructorId,
    getApprovedClassByInstructorId,
    approveClass
};