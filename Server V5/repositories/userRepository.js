...
const SQL_INSERT = "INSERT INTO AppUser (FirstName, LastName, DateOfBirth, PhoneNumber, Email,  Role) VALUES (@firstName, @lastName, @dateOfBirth, @phoneNumber, @email, @role);";
