...
// GET Replied QUERIES
router.get('/repliedqueries/', async(req, res) => {
    let result;
    // If validation passed execute query and return results
    // returns a single query with matching id
    try {
        // Send response with JSON result    
        result = await queryService.getRepliedQueries();
        console.log(result);
        res.json(result);
...
router.put('/reply', async(req, res) => {
    ...
    console.log("queryController update reply: ", reply);

    try {
        // Send response with JSON result    
        result = await queryService.updateReply(reply);
...
router.delete('/:id', async(req, res) => {
    ...
    console.log("queryController Delete: ", queryId);
    // If validation passed execute query and return results
    // returns a single query with matching id
    try {
        // Send response with JSON result    
