...
function displayMemberships(memberships) {
    ...
    if (memberships != null) {
        const rows = memberships.map(membership => {
            ...
            let row =   `<div class="col col-md-4">
                            <div class="card">
                                <div class="card-header bg-primary">${membership.membershipName}</div>
                                <div class="card-body">
                                    <h2 class="card-title">&euro;${Number(membership.membershipPrice).toFixed(2)}</h2>
                                    <p class="card-text">Save &euro; ${Number(membership.membershipPrice/3).toFixed(2)}</p>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">${membership.membershipSessions} Sessions</li>
                                        <li class="list-group-item">Dapibus ac facilisis in</li>
                                        <li class="list-group-item">Vestibulum at eros</li>
                                    </ul>
                                    <div class="card-body">
                                        <button class="btn btn-dark buyMembership" onclick="buyMembership(${membership.membershipId})">Buy</button>
                                    </div>
                                </div>
                            </div>
                        </div>`;
            ...
            //       <span class="oi oi-cart" data-toggle="tooltip" title="BUY Membership">BUY2222</span></button>
            //     </td>`
